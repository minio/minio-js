...
describe('Client', function() {
  ...
  describe('User Agent', () => {
    ...
    it('should set user agent', () => {
      ...
      client.setAppInfo('test', '2.0.3')
      assert.equal(`Minio (${process.platform}; ${process.arch}) minio-js/${Package.version} test/2.0.3`,
                   client.userAgent)
    })
