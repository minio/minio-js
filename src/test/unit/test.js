...
describe('Client', function() {
  ...
  describe('User Agent', () => {
    ...
    it('should set user agent', () => {
      ...
      client.setAppInfo('test', '3.1.2')
      assert.equal(`Minio (${process.platform}; ${process.arch}) minio-js/${Package.version} test/3.1.2`,
                   client.userAgent)
    })
